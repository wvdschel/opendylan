...
define integer-designator-class <C-raw-size> <C-integer> unsigned primitive-wrap-machine-word end;
define integer-designator-class <C-raw-signed-long> <C-integer> signed primitive-wrap-machine-word end;
define integer-designator-class <C-raw-ssize> <C-integer> signed primitive-wrap-machine-word end;
